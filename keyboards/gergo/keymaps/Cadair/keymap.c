...
[BASE] = LAYOUT_gergo(
    ...
    KC_LSFT,               KC_A,  KC_S,   KC_D,  KC_F, KC_G, KC_BSPC,                   LM(NUMB, MOD_LGUI),  KC_H,  KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT,
    MT(MOD_LCTL, KC_BSPC), KC_Z,  KC_X,   KC_C,  KC_V, KC_B, SH_TG,  KC_BTN3,  KC_PGDN, SH_TG,               KC_N,  KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
