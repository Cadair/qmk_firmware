...
[BASE] = LAYOUT_gergo(
    ...
    KC_LSFT,               KC_A,  KC_S,   KC_D,  KC_F, KC_G, KC_APP,                      LM(NUMB, MOD_LGUI),  KC_H,  KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT,
    MT(MOD_LCTL, KC_BSPC), KC_Z,  KC_X,   KC_C,  KC_V, KC_B, KC_TRNS,  KC_BTN3,  KC_PGDN, KC_BSPC,             KC_N,  KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,

    MT(MOD_LALT, KC_DEL),  MT(MOD_LGUI, KC_ENT), LT(SYMB, KC_SPC), LT(NUMB, KC_ESC),            LT(SYMB, KC_ENT), LT(NUMB, KC_SPC),  KC_TAB, KC_RALT
    ),  
 ...
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |        |  F1  |  F2  | F3   | F4   | F5   | F6   |           | HOME | LEFT | DOWN |  UP  | RIGHT| END  |  Back  |
 * |--------+------+------+------+------+------+------|           |------|------+------+------+------+------+--------|
...
[NUMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                         KC_HOME,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,  KC_MPRV,
 ...
 *
 * ,---------------------------------------------.                         ,-------------------------------------------.
 * |    F5    |   Q  |   W  |   E  |   R  |   T  |                         |   Y  |   U  |   I  |   O  |   P  |  BKSP  |
 * |----------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * | LShift   |   A  |   S  |   D  |   F  |   G  |  F1  |           | i3-1 |   H  |   J  |   K  |   L  | ;  : |  ' "   |
 * |----------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * |   Ctl    |   Z  |   X  |   C  |   V  |   B  |  F2  |           | BKSP |   N  |   M  | ,  < | . >  | /  ? |  - _   |
 * `----------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                    .----------.   .---------.                            .------.   .-----.
 *                    |   ALT    |   |   Tab   |                            | Tab  |   |BKSP |
 *                    '----------'   '---------'                            `------.   '-----
 ...
 *                                 ,------|-------|                      |-------|------.
 *                                 |      |       |                      | SYMB  | NUMB |
 *                                 | Space| Enter |                      | Ent   |Space |
 *                                 |      |       |                      |       |      |
 *                                 `--------------'                      `--------------'
 */
[GAME] = LAYOUT_gergo(
    KC_F5,   KC_Q,  KC_W,   KC_E,  KC_R, KC_T,                                                          KC_Y,  KC_U, KC_I,    KC_O,   KC_P,    KC_BSPC,
    KC_LSFT,  KC_A,  KC_S,   KC_D,  KC_F, KC_G, KC_F1,                             LM(NUMB, MOD_LGUI),  KC_H,  KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT,
    KC_LCTL, KC_Z,  KC_X,   KC_C,  KC_V, KC_B, KC_F2,  KC_F3,     KC_ESC,        KC_BSPC,             KC_N,  KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,

    KC_LALT,  KC_TAB, KC_SPC, KC_ENT,                             LT(SYMB, KC_ENT), LT(NUMB, KC_SPC),  KC_TAB, KC_RALT
    ),  
};
/* Keymap template
 *
